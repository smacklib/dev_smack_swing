...
import org.smack.swing.swingx.plaf.XListAddon;
import org.smack.swing.swingx.plaf.basic.core.BasicXListUI;
import org.smack.swing.swingx.renderer.AbstractRenderer;
import org.smack.swing.swingx.renderer.DefaultListRenderer;
import org.smack.swing.swingx.renderer.StringValue;
import org.smack.swing.swingx.rollover.ListRolloverController;
import org.smack.swing.swingx.rollover.ListRolloverProducer;
import org.smack.swing.swingx.rollover.RolloverProducer;
import org.smack.swing.swingx.rollover.RolloverRenderer;
import org.smack.swing.swingx.search.ListSearchable;
...
import org.smack.swing.swingx.sort.ListSortController;
...
public class JXList extends JList {
    ...
    /**
     * Constructs a <code>JXList</code> that displays the elements in
     * the specified <code>List</code> and automatic creation of a RowSorter disabled.
     *
    ...
    /**
     * Constructs a <code>JXList</code> that displays the elements in
     * the specified <code>List</code> and filtersEnabled property.
     *
     * @param  listData  the <code>List</code> to be loaded into the
     *          data model
     * @param autoCreateRowSorter <code>boolean</code> to determine if
     ...
     */
    public <E> JXList(List<E> listData, boolean autoCreateRowSorter) {
        super( new Vector<E>( listData ) );
        if (listData == null)
           throw new IllegalArgumentException("listData must not be null");
        init(autoCreateRowSorter);
    }
     ...
     * @see org.smack.swing.swingx.search.ListSearchable
     */
...
//------------------------- sort: do sort/filter
    ...
    protected static class ListAdapter extends ComponentAdapter {
         ...
         *
         * @return the target component as a {@link org.smack.swing.swingx.JXList}
         */
