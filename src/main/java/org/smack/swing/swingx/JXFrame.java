...
//    private final DisplayMode originalDisplayMode = device.getDisplayMode();
    ...
    private void fullscreenOn()
    {
        ...
        _fsExtendedState = getExtendedState();
...
//        device.setDisplayMode(originalDisplayMode);
        ...
        setExtendedState( _fsExtendedState );

        if ( wasVisible )
            setVisible( true );
    }

    public static final String PN_FULLSCREEN = "fullscreen";
    ...
    public void setFullscreen( boolean newValue )
    {
        ...
        boolean old = _fullscreen;
        _fullscreen = newValue;

        firePropertyChange( PN_FULLSCREEN, old, _fullscreen );
    }
}
