 ...
 * swing Actions (referred to as <i>behaviour actions</i>) that are embedded
 ...
 * (unless explicitly bound). Behavior actions have no properties but have
 ...
 * <p>
 * The {@link org.smack.swing.swingx.action.AbstractActionExt} class extends the Swing
 ...
 * <p>
 * There are two types of user actions: A {@link org.smack.swing.swingx.action.BoundAction}
 * is an action that will invoke a specific method. It may be bound to an explicit
 * component, a callback method on an object instance or one or more listeners.
 * A {@link org.smack.swing.swingx.action.TargetableAction} is an action that doesn't have an
 * explicit binding and the invocation will be sent to an arbitrator
 * (the {@link org.smack.swing.swingx.action.TargetManager}) which dispatches the Action
 * to the "current component" - represented by a Targetable instance.
 * The current component may be explicitly set by some programmatic
 ...
 * <p>
 * <dl>
 * <dt> {@link org.smack.swing.swingx.action.ActionManager}</dt>
 ...
 * </dd>
 *
 * <dt>{@link org.smack.swing.swingx.action.ActionContainerFactory}</dt>
 ...
 * </dd>
 *
 * <dt>{@link org.smack.swing.swingx.action.TargetableAction}</dt>
 * <dd>Represents an unbound Action. The invocation of this action
 * will be dispatched to the TargetManager.</dd>
 *
 * <dt>{@link org.smack.swing.swingx.action.BoundAction}</dt>
 * <dd>Represents an action which has an exclicit binding.</dd>
 *
 * <dt>{@link org.smack.swing.swingx.action.TargetManager}</dt>
 ...
 * </dd>
 *
 * <dt>{@link org.smack.swing.swingx.action.Targetable}</dt>
