...
public class SearchFieldAddon extends AbstractComponentAddon {
    ...
    protected void addBasicDefaults(LookAndFeelAddons addon, DefaultsList defaults) {
		...
		//webstart fix
		UIManagerExt.addResourceBundle("org.smack.swing.swingx.plaf.basic.resources.SearchField");
//		UIManager.getDefaults().addResourceBundle("org.smack.swing.swingx.plaf.basic.resources.SearchField");
	}
