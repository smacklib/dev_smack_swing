 ...
 * <code>LookAndFeelAddons.setAddon("org.smack.swing.swingx.plaf.windows.WindowsLookAndFeelAddons");</code>.
 * 
...
public abstract class LookAndFeelAddons {
            ...
            return AccessController.doPrivileged(new PrivilegedAction<String>() {
                ...
                public String run() {
                    return System.getProperty("swing.crossplatformlafaddon",
                            "org.smack.swing.swingx.plaf.metal.MetalLookAndFeelAddons");
                }
            });
        } catch (SecurityException ignore) {
        }

        return "org.smack.swing.swing.plaf.metal.MetalLookAndFeelAddons";
    }
    ...
    public static ComponentUI getUI(JComponent component, Class<?> expectedUIClass) {
        ...
        if (uiClassname == null) {
            ...
            // issue
            uiClassname = "org.smack.swing.swingx.plaf.basic.Basic" + expectedUIClass.getSimpleName();
        }
        try {
